from BoaHancockBOT import STRAWHATS, YONKO, ADMIRALS
...
class CustomFilters(object):
    ...
    class _Supporters(BaseFilter):
        ...
        def filter(self, message: Message):
            return bool(message.from_user and message.from_user.id in ADMIRALS)
    ...
    class _Sudoers(BaseFilter):
        ...
        def filter(self, message: Message):
            return bool(message.from_user and message.from_user.id in YONKO)
    ...
    class _Developers(BaseFilter):
        ...
        def filter(self, message: Message):
            return bool(message.from_user and message.from_user.id in STRAWHATS)
