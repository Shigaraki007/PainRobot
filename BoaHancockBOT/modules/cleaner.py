...
from BoaHancockBOT import ALLOW_EXCL, CustomCommandHandler, dispatcher
from BoaHancockBOT.modules.disable import DisableAbleCommandHandler
from BoaHancockBOT.modules.helper_funcs.chat_status import (bot_can_delete,
                                                           connection_status,
                                                           dev_plus, user_admin)
from BoaHancockBOT.modules.sql import cleaner_sql as sql
 ...
 *Following are the 6 Paths only commands, admins cannot use these:*
